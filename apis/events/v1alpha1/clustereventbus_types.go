...
//+kubebuilder:resource:shortName=ceb,scope=Cluster
...
type ClusterEventBusList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ClusterEventBus `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ClusterEventBus{}, &ClusterEventBusList{})
}
