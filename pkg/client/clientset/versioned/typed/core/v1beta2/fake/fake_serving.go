...
var servingsResource = v1beta2.SchemeGroupVersion.WithResource("servings")

var servingsKind = v1beta2.SchemeGroupVersion.WithKind("Serving")
...
func (c *FakeServings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(servingsResource, c.ns, name, opts), &v1beta2.Serving{})
