...
func (c *FakeBuilders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.Builder, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(buildersResource, c.ns, name), &v1beta2.Builder{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta2.Builder), err
}

// List takes label and field selectors, and returns the list of Builders that match those selectors.
func (c *FakeBuilders) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.BuilderList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(buildersResource, buildersKind, c.ns, opts), &v1beta2.BuilderList{})
	...
	list := &v1beta2.BuilderList{ListMeta: obj.(*v1beta2.BuilderList).ListMeta}
	for _, item := range obj.(*v1beta2.BuilderList).Items {
...
func (c *FakeBuilders) Create(ctx context.Context, builder *v1beta2.Builder, opts v1.CreateOptions) (result *v1beta2.Builder, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(buildersResource, c.ns, builder), &v1beta2.Builder{})
...
func (c *FakeBuilders) Update(ctx context.Context, builder *v1beta2.Builder, opts v1.UpdateOptions) (result *v1beta2.Builder, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(buildersResource, c.ns, builder), &v1beta2.Builder{})
...
func (c *FakeBuilders) UpdateStatus(ctx context.Context, builder *v1beta2.Builder, opts v1.UpdateOptions) (*v1beta2.Builder, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(buildersResource, "status", c.ns, builder), &v1beta2.Builder{})
...
func (c *FakeBuilders) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta2.BuilderList{})
	return err
}

// Patch applies the patch and returns the patched builder.
func (c *FakeBuilders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.Builder, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(buildersResource, c.ns, name, pt, data, subresources...), &v1beta2.Builder{})
