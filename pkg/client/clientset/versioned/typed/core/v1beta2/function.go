...
func newFunctions(c *CoreV1beta2Client, namespace string) *functions {
	return &functions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *functions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.Function, err error) {
	result = &v1beta2.Function{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("functions").
		Name(name).
...
func (c *functions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.FunctionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.FunctionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("functions").
...
func (c *functions) Create(ctx context.Context, function *v1beta2.Function, opts v1.CreateOptions) (result *v1beta2.Function, err error) {
	result = &v1beta2.Function{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("functions").
...
func (c *functions) Update(ctx context.Context, function *v1beta2.Function, opts v1.UpdateOptions) (result *v1beta2.Function, err error) {
	result = &v1beta2.Function{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("functions").
...
func (c *functions) UpdateStatus(ctx context.Context, function *v1beta2.Function, opts v1.UpdateOptions) (result *v1beta2.Function, err error) {
	result = &v1beta2.Function{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("functions").
...
func (c *functions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.Function, err error) {
	result = &v1beta2.Function{}
