...
func newBuilders(c *CoreV1beta2Client, namespace string) *builders {
	return &builders{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *builders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.Builder, err error) {
	result = &v1beta2.Builder{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("builders").
		Name(name).
...
func (c *builders) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.BuilderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.BuilderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("builders").
...
func (c *builders) Create(ctx context.Context, builder *v1beta2.Builder, opts v1.CreateOptions) (result *v1beta2.Builder, err error) {
	result = &v1beta2.Builder{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("builders").
...
func (c *builders) Update(ctx context.Context, builder *v1beta2.Builder, opts v1.UpdateOptions) (result *v1beta2.Builder, err error) {
	result = &v1beta2.Builder{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("builders").
...
func (c *builders) UpdateStatus(ctx context.Context, builder *v1beta2.Builder, opts v1.UpdateOptions) (result *v1beta2.Builder, err error) {
	result = &v1beta2.Builder{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("builders").
...
func (c *builders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.Builder, err error) {
	result = &v1beta2.Builder{}
