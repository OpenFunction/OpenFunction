...
var functionsResource = schema.GroupVersionResource{Group: "core.openfunction.io", Version: "v1alpha2", Resource: "functions"}

var functionsKind = schema.GroupVersionKind{Group: "core.openfunction.io", Version: "v1alpha2", Kind: "Function"}

// Get takes name of the function, and returns the corresponding function object, and an error if there is any.
func (c *FakeFunctions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Function, err error) {
	obj, err := c.Fake.
...
func (c *FakeFunctions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.FunctionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeFunctions) Create(ctx context.Context, function *v1alpha2.Function, opts v1.CreateOptions) (result *v1alpha2.Function, err error) {
	obj, err := c.Fake.
...
func (c *FakeFunctions) Update(ctx context.Context, function *v1alpha2.Function, opts v1.UpdateOptions) (result *v1alpha2.Function, err error) {
	obj, err := c.Fake.
...
func (c *FakeFunctions) UpdateStatus(ctx context.Context, function *v1alpha2.Function, opts v1.UpdateOptions) (*v1alpha2.Function, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(functionsResource, "status", c.ns, function), &v1alpha2.Function{})
...
func (c *FakeFunctions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Function, err error) {
	obj, err := c.Fake.
