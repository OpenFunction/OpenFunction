...
var buildersResource = v1beta1.SchemeGroupVersion.WithResource("builders")

var buildersKind = v1beta1.SchemeGroupVersion.WithKind("Builder")
...
func (c *FakeBuilders) UpdateStatus(ctx context.Context, builder *v1beta1.Builder, opts v1.UpdateOptions) (*v1beta1.Builder, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(buildersResource, "status", c.ns, builder), &v1beta1.Builder{})
...
func (c *FakeBuilders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(buildersResource, c.ns, name, opts), &v1beta1.Builder{})
