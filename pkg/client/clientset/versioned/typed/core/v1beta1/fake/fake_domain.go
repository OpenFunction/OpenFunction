...
func (c *FakeDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Domain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(domainsResource, c.ns, name), &v1beta1.Domain{})
...
func (c *FakeDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DomainList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(domainsResource, domainsKind, c.ns, opts), &v1beta1.DomainList{})
	...
	list := &v1beta1.DomainList{ListMeta: obj.(*v1beta1.DomainList).ListMeta}
	for _, item := range obj.(*v1beta1.DomainList).Items {
...
func (c *FakeDomains) Create(ctx context.Context, domain *v1beta1.Domain, opts v1.CreateOptions) (result *v1beta1.Domain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(domainsResource, c.ns, domain), &v1beta1.Domain{})
...
func (c *FakeDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(domainsResource, c.ns, name), &v1beta1.Domain{})
...
func (c *FakeDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.DomainList{})
	return err
}

// Patch applies the patch and returns the patched domain.
func (c *FakeDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Domain, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(domainsResource, c.ns, name, pt, data, subresources...), &v1beta1.Domain{})
