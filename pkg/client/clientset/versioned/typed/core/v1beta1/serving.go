...
type ServingInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ServingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Serving, err error)
	ServingExpansion
}
...
func newServings(c *CoreV1beta1Client, namespace string) *servings {
	return &servings{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *servings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Serving, err error) {
...
func (c *servings) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ServingList, err error) {
...
func (c *servings) Create(ctx context.Context, serving *v1beta1.Serving, opts v1.CreateOptions) (result *v1beta1.Serving, err error) {
	result = &v1beta1.Serving{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servings").
...
func (c *servings) Update(ctx context.Context, serving *v1beta1.Serving, opts v1.UpdateOptions) (result *v1beta1.Serving, err error) {
	result = &v1beta1.Serving{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servings").
...
func (c *servings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Serving, err error) {
	result = &v1beta1.Serving{}
