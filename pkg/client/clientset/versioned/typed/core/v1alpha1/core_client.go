...
// CoreV1alpha1Client is used to interact with features provided by the core.openfunction.io group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) Builders(namespace string) BuilderInterface {
	return newBuilders(c, namespace)
}

func (c *CoreV1alpha1Client) Functions(namespace string) FunctionInterface {
	return newFunctions(c, namespace)
}

func (c *CoreV1alpha1Client) Servings(namespace string) ServingInterface {
