...
func newServings(c *CoreV1alpha1Client, namespace string) *servings {
	return &servings{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *servings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Serving, err error) {
...
func (c *servings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServingList, err error) {
...
func (c *servings) Create(ctx context.Context, serving *v1alpha1.Serving, opts v1.CreateOptions) (result *v1alpha1.Serving, err error) {
	result = &v1alpha1.Serving{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servings").
...
func (c *servings) Update(ctx context.Context, serving *v1alpha1.Serving, opts v1.UpdateOptions) (result *v1alpha1.Serving, err error) {
	result = &v1alpha1.Serving{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servings").
...
func (c *servings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Serving, err error) {
	result = &v1alpha1.Serving{}
